...
angular.module('Landing')
  .controller('ModalCtrl', function ($scope, $stateParams, $sce) {
    ...
    $scope.ids = [
    	...
    	},
        {
            id: 2,
            name: "Amplive",
            bio: "<p>Amplive creates opportunities for your live content to be discovered by the right people at the right time</p><h3>My role:</h3><p>I'm the lead developer for Amplive. I work on building out their web platform as well as code different architecture for their data-driven needs.</p>",
            location: "San Francisco, CA",
            url: "http://amplive.us",
            cover: "images/amplive.jpg"
        },
        {
            id: 3,
